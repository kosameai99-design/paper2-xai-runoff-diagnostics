...
def _plot_fig6_soil_type(ax, basins, japan):
    soil_module = _module_from_path("paper2_soil_type_wrr_polish_v1", SOIL_SCRIPT)
...
def write_notes(paths: dict[str, Path]) -> None:
    notes = [
        "# Paper 2 Figure QC notes WRR polish v3",
        "",
        "Generated without rerunning the hydrologic model or IG analysis. This is a targeted Figure 4/Figure 5 revision for the v17 manuscript.",
        "",
        "## Outputs",
    ]
